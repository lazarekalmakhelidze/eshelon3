...
Keep the style bold, youthful, and highly confident (as a top-tier digital agency). Do not mention any JSON syntax in the text, just return the valid JSON.`;
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-[#f2f2f2] font-sans antialiased selection:bg-[#E50914] selection:text-white">
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-3">
              ...
              >
                ...
                <div>
                  <span className="text-xl font-black tracking-widest text-white block group-hover:text-gray-300 transition">ESHELON</span>
      ...
      >
        {/* Cover image wrapper — smooth parallax on mouse move */}
        <div
          className="absolute inset-0 transition-transform duration-[600ms] ease-out will-change-transform"
          style={{ transform: `translate(${mouse.x * -1}px, ${mouse.y * -1}px) scale(1.04)` }}
        >
          {/* Desktop */}
          <img
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#0d0d0d] via-[#0d0d0d]/90 to-[#0d0d0d]/10 w-full z-10" />
        <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-[#0d0d0d] via-[#0d0d0d]/80 to-transparent z-10" />
        <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-[#0d0d0d]/80 to-transparent z-10 hidden lg:block" />
      ...
      <section id="services" className="py-24 bg-[#0a0a0a] border-y border-[#1e1e1e] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Service 1 */}
            <div className="bg-[#121212] border border-white/5 p-8 rounded-2xl hover:border-[#E50914]/40 hover:-translate-y-1 transition duration-300 group">
            ...
            {portfolioData.map((project) => (
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <p className="text-sm text-gray-400 line-clamp-3 group-hover:text-gray-300 transition">
                    {project.description}
                  </p>
      ...
      {/* PORTFOLIO MODAL WITH SCROLL LOCK */}
      {selectedProject && (
        <div
            ...
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.tags.map((tag, idx) => (
                      <span key={idx} className="text-xs font-mono px-3 py-1 rounded-md bg-[#1a1a1a] text-white border border-[#333] uppercase tracking-wider hover:border-[#E50914]/50 transition">
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              <div className="px-8 pb-8 pt-4 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 bg-[#E50914] text-white font-bold rounded-lg text-xs hover:bg-red-700 hover:shadow-lg hover:shadow-[#E50914]/20 transition"
                >
      ...
      <section id="ai-strategist" className="py-24 bg-gradient-to-b from-[#0a0a0a] to-[#121212] border-t border-[#1e1e1e] relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#181818] border border-white/10 rounded-2xl p-6 sm:p-10 shadow-xl hover:border-white/20 transition duration-300">
              <form onSubmit={generateAIStrategy} className="space-y-6">
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    disabled={aiLoading}
                    className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 bg-[#E50914] text-white font-bold rounded-xl text-sm hover:bg-red-700 transition duration-200 disabled:bg-gray-800 disabled:text-gray-500 cursor-pointer active:scale-95"
                  >
                    {aiLoading ? (
                      <>
              ...
              {aiStrategyResult && (
                <div className="mt-8 pt-8 border-t border-white/10 space-y-6 animate-fade-in">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-black/40 border border-white/5 p-6 rounded-xl space-y-3 hover:border-white/10 transition">
                  ...
                  <div className="bg-black/40 border border-white/5 p-6 rounded-xl space-y-4 hover:border-white/10 transition">
      ...
      <section id="pricing" className="py-24 bg-[#0d0d0d] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            {activeTab === 'branding' ? (
              brandingPackages.map((pkg, idx) => (
                <div
                  key={idx}
                  className={`bg-[#121212] border rounded-2xl p-8 flex flex-col justify-between transition duration-300 relative hover:-translate-y-1 hover:shadow-xl ${pkg.featured ? 'border-[#E50914] shadow-lg shadow-[#E50914]/5 ring-1 ring-[#E50914]' : 'border-white/5 hover:border-white/20'}`}
                >
                  {pkg.featured && (
                    <div className="absolute top-0 right-8 -translate-y-1/2 px-3 py-1 bg-[#E50914] text-white text-[10px] font-bold tracking-wider rounded-full uppercase shadow-[0_0_10px_rgba(229,9,20,0.5)]">
                      ყველაზე პოპულარული
                    </div>
                  )}
                  ...
                  <div className="pt-8">
                    <button
                      ...
                      className={`w-full py-3.5 px-4 rounded-xl font-bold text-xs transition duration-200 active:scale-95 ${pkg.featured ? 'bg-[#E50914] text-white hover:bg-red-700' : 'bg-[#1a1a1a] text-white hover:bg-white/10 border border-white/10'}`}
                    >
                      არჩევა და შეკვეთა
                    </button>
                  </div>
          ...
          <div className="mt-20 bg-[#121212] border border-white/5 rounded-2xl p-6 sm:p-10 max-w-4xl mx-auto hover:border-white/10 transition duration-300">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    className="w-5 h-5 rounded border-white/10 text-[#E50914] focus:ring-[#E50914] bg-black cursor-pointer"
                  />
                </div>
              ...
              <div className="bg-black/40 border border-white/5 rounded-xl p-6 flex flex-col justify-between text-center md:text-left">
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="w-full py-4 bg-white text-black font-bold rounded-xl text-xs hover:bg-gray-100 transition active:scale-95 shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 group">
                  <div className="w-10 h-10 rounded-lg bg-[#121212] border border-white/5 flex items-center justify-center text-[#E50914] group-hover:bg-[#E50914] group-hover:text-white transition duration-300">
            ...
            <div className="lg:col-span-7">
              <div className="bg-[#121212] border border-white/5 rounded-2xl p-6 sm:p-10 hover:border-white/10 transition duration-300">
                ...
                <form onSubmit={(e) => { e.preventDefault(); setOrderSuccess(true); setTimeout(() => setOrderSuccess(false), 3000); }} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        type="text"
                        className="w-full bg-black/60 border border-white/10 rounded-lg p-3.5 text-white text-sm focus:outline-none focus:border-[#E50914] focus:ring-1 focus:ring-[#E50914] transition"
                  ...
                  <div>
                    ...
                    <textarea
                      className="w-full bg-black/60 border border-white/10 rounded-lg p-3.5 text-white text-sm focus:outline-none focus:border-[#E50914] focus:ring-1 focus:ring-[#E50914] transition h-32 resize-none"
      ...
      {/* DIRECT PACKAGE ORDER MODAL WITH SCROLL LOCK */}
      {orderModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#121212] border border-white/10 rounded-2xl max-w-md w-full p-6 sm:p-8 relative shadow-[0_0_50px_rgba(0,0,0,0.8)] animate-slide-up">
            <button
            ...
            <form onSubmit={handleOrderSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/60 border border-white/10 rounded-lg p-3 text-white text-xs focus:outline-none focus:border-[#E50914] focus:ring-1 focus:ring-[#E50914] transition"
                  placeholder="მაგ: გიორგი"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-black/60 border border-white/10 rounded-lg p-3 text-white text-xs focus:outline-none focus:border-[#E50914] focus:ring-1 focus:ring-[#E50914] transition h-20 resize-none"
              ...
              <button
                type="submit"
                className="w-full py-4 bg-[#E50914] text-white font-bold rounded-xl text-xs hover:bg-red-700 transition active:scale-95 shadow-[0_0_15px_rgba(229,9,20,0.2)]"
              >
